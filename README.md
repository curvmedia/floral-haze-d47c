...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/floral-haze-d47c)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/floral-haze-d47c
```

A live public deployment of this template is available at [https://floral-haze-d47c.templates.workers.dev](https://floral-haze-d47c.templates.workers.dev)
